...
define([
    ...
    return substitution({
        ...
        'error.code.DAHGETQUERYTAGVALUES502': 'Query non valida: tutte le parole sono stopwords, oppure troppo brevi, o non sono scritte in modo corretto',
        'error.code.AXEGETQUERYTAGVALUES502': 'Query non valida: tutte le parole sono stopwords, oppure troppo brevi, o non sono scritte in modo corretto',
        'error.code.DAHQUERY502': 'Query non valida: tutte le parole sono stopwords, oppure troppo brevi, o non sono scritte in modo corretto',
        'error.code.AXEQUERY502': 'Query non valida: tutte le parole sono stopwords, oppure troppo brevi, o non sono scritte in modo corretto',
        'error.code.DAHGETQUERYTAGVALUES512': 'Testo della ricerca incomprensibile',
        'error.code.AXEGETQUERYTAGVALUES512': 'Testo della ricerca incomprensibile',
        'error.code.DAHQUERY512': 'Testo della ricerca incomprensibile',
        'error.code.AXEQUERY512': 'Testo della ricerca incomprensibile'
    });
});
